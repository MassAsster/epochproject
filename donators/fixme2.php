...
//	$guid="". $row['guid'] ."";
if($multicharactersupport == 1) {
mysql_query("UPDATE `$chartablename` SET Medical='[false,false,false,false,false,false,false,12000,[],[0,0],0,[345.949,630.034]]', CurrentState='[\"\",\"\",42]' WHERE CharacterID='$charda' AND Slot = '$slot' ");
}
else {
mysql_query("UPDATE `$chartablename` SET Medical='[false,false,false,false,false,false,false,12000,[],[0,0],0,[345.949,630.034]]', CurrentState='[\"\",\"\",42]' WHERE CharacterID='$charda' ");
}
...
<td>";
Echo "Transaction in-progress<P>Character being repaired...<P>";
