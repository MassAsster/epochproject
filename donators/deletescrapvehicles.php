...
mysql_query("DELETE FROM `$objecttable` WHERE `CharacterID` = '0' AND `Inventory` = '[[[],[]],[[],[]],[[],[]]]'");

mysql_query("DELETE FROM `$objecttable` WHERE Damage = '1'");
mysql_query("DELETE FROM `$objecttable` WHERE CharacterID = '0' AND Inventory = '[]'");

  echo "Clean up of Damaged, un-keyed, non-inventory vehicles complete.<P><a href='admintools.php'>Back</a> ";
